  ...
  const handleSearch = async (e: FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const filtered = data.filter((creator: Creator) =>
  ...
  return (
    <div className="min-h-screen bg-dark-bg">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-white mb-6">Search Creators</h1>
        ...
        {searched && (
          <>
            {loading ? (
              ...
              <>
                <p className="text-gray-400 mb-4">Found {creators.length} creator{creators.length !== 1 ? 's' : ''}</p>
