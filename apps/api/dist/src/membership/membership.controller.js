...
let MembershipController = class MembershipController {
    ...
    async subscribe(req, body) {
        return this.membershipService.createMembership(req.user.id, body.creatorId, body.tierId);
    }
    async cancelMembership(req, membershipId) {
        return this.membershipService.cancelMembership(membershipId, req.user.id);
    }
};
...
], MembershipController.prototype, "getMyMemberships", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MembershipController.prototype, "cancelMembership", null);
